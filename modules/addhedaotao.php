...
<?php
    if(isset($_POST["addNew"])){
        $catName = $_POST["ten_hdt"];
        $sqlInsert = save('tbl_hedaotao',$_POST);
          ...
          <div class="container-fluid  dashboard-content">
            <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Thêm mới hệ đào tạoc</h5>
                                <div class="card-body">
                                    <form action="" enctype="multipart/form-data" id="basicform" data-parsley-validate="" method="post">
                                        <div class="form-group">
                                            ...
                                            <input id="ten_hdt" type="text" name="ten_hdt" placeholder="Nhập tên hệ đào tạo" class="form-control">
                                        </div>
                                        <div class="row">
